import {
  Link2, MessageCircle, ShoppingBag, Music2, Facebook, Instagram, Youtube,
  MapPin, Calendar, Coffee, Briefcase, FileText, Mail, Linkedin, Phone,
  Globe, Store, Star, Sun, CreditCard, QrCode,
} from "lucide-react";
